...
### Projeto realizado como estudante na [Trybe](https://www.betrybe.com/).
 ...
 ### O que foi desenvolvido:
  ...
  Será utilizado a Programação Orientada a Objetos! Será desenvolvido um **gerador de relatórios** que recebe como entrada arquivos com dados de um estoque e gera, como saída, um relatório acerca destes dados.
